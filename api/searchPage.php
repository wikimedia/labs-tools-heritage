...
class SearchPage {
	...
	private function getSearchForm() {
		...
		$result[] = '<tr>';
		$result[] = '<th>' . _i18n( 'search-table-th-field' ) . '</th>';
		$result[] = '<th>' . _i18n( 'search-table-th-search' ) . '</th>';
		$result[] = '<th>' . _i18n( 'search-table-th-filter' ) . '</th>';
		$result[] = '</tr>';
		$result[] = '<tr>';
		$result[] = '<td><label>' . _i18n( 'search-table-tr-countries' ) . '</label></td>';
		...
		$result[] = '</tr>';
		$result[] = '<tr>';
		$result[] = '<td><label>' . _i18n( 'search-table-tr-languages' ) . '</label></td>';
		...
		$result[] = '</tr>';
		$result[] = '<tr>';
		$result[] = '<td><label>' . _i18n( 'search-table-tr-name' ) . '</label></td>';
	...
	// $result = array_merge($result, $this->getNameSelect());
		...
		$result[] = '</tr>';
		$result[] = '<tr>';
		$result[] = '<td><label>' . _i18n( 'search-table-tr-address' ) . '</label></td>';
	...
	// $result = array_merge($result, $this->getAddressSelect());
		...
		$result[] = '</tr>';
		$result[] = '<tr>';
		$result[] = '<td><label>' . _i18n( 'search-table-tr-municipality' ) . '</label></td>';
	...
	// $result = array_merge($result, $this->getMunicipalitySelect());
		...
		$result[] = '</tr>';
		$result[] = '<tr>';
		$result[] = '<td><label>' . _i18n( 'search-table-tr-coordinates' ) . '</label></td>';
	...
	// $result = array_merge($result, $this->getImagesSelect());
		...
		$result[] = '</tr>';
		$result[] = '<tr>';
		$result[] = '<th colspan="3">' . _i18n( 'search-table-th-output' ) . '</th>';
		$result[] = '</tr>';
		$result[] = '<tr>';
		$result[] = '<td><label>' . _i18n( 'search-table-tr-output-language' ) . '</label></td>';
		$result[] = '<td colspan="2">';
		$result = array_merge( $result, $this->getOutputLanguageSelect() );
		$result[] = '</td>';
		$result[] = '</tr>';
		$result[] = '<tr>';
		$result[] = '<td><label>' . _i18n( 'search-table-tr-output-format' ) . '</label></td>';
		$result[] = '<td colspan="2">';
		$result = array_merge( $result, $this->getOutputFormatSelect() );
		$result[] = '</td>';
		$result[] = '</tr>';
		$result[] = '<tr>';
		$result[] = '<td colspan="3" align="right"><input type="submit" value="' . _i18n( 'search-table-button-search' ) . '"> </td>';
		$result[] = '</tr>';
		$result[] = '</table>';
		$result[] = '</form>';
		return $result;
