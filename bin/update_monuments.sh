...
jsub -release buster -mem 1000m -once -j y -o $LOGS_PATH/categorize_images.log -N $CATEGORIZATION_JOB_NAME $SOURCE_PATH/bin/categorize_images.sh >> $LOGS_PATH/crontab.log
