<?php
/**
 * Interface messages which may be useful for a Skin.
 *
...
$messages['en'] = array(
	...
	'skins' => 'skins',
	'personaltools' => '',
	'translate-tool-msg' => 'Translate',
	'server-status' => 'Server status',

	'set-as-default-skin' => 'Set default skin',
	'query-set-default-skin' => 'Do you want to set $1 as your default skin?',
	'set-default-lang' => 'Set language',
 ...
 */
$messages['qqq'] = array(
	'tool' => 'Title of the main tab',
	'skins' => 'Title of the skins portlet',
	'translate-tool-msg' => 'Caption of the link to translatewiki',
	'server-status' => 'Title of the portlet showing the status of the different servers',

	'set-as-default-skin' => 'Caption of the link to set the current skin as the default one',
	'query-set-default-skin' => 'Confirmation question performed on clicking the \'set-as-default-skin\' link',
	'set-default-lang' => 'Caption of the link to change the current language',

	'personaltools' => '{{optional}} Unused. Removes the personal tools.',
	'toolbox' => 'The title of the toolbox in the left bar. {{Identical|toolbox}}',
	'otherlanguages' => 'This message is shown under the toolbox. Shows the languages to which this tool is translated.
{{Identical|otherlanguages}}',
	'pipe-separator' => '{{optional}} {{Identical|pipe-separator}}',
	'views' => '{{Identical|views}}',
	'viewsource' => 'Caption of the tab to view the source code {{Identical|viewsource}} {{Identical|view-source}}',
);
