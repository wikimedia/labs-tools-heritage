...
countries = {
	...
	'rowTemplate' : u'Tabelrij erfgoed Vlaanderen',
        ...
        'unusedImagesPage' : u'Wikipedia:Wikiproject/Erfgoed/Belgische Erfgoed Inventarisatie/Ongebruikte foto\'s',
        'imagesWithoutIdPage' : u'Wikipedia:Wikiproject/Erfgoed/Belgische Erfgoed Inventarisatie/Foto\'s zonder id',
	'namespaces' : [0],
