...
countries = {
	...
	'project' : 'wikipedia',
	'lang' : 'be-x-old',
	'headerTemplate' : 'Вікі любіць славутасьці/Вяршыня сьпісу',
	...
	'fields' : [
		...
		'conv' : '',
            ...
            {
		'source' : 'грамадзкі набытак', # Boolean, not clear what the purpose is
		'dest' : '',
		'conv' : '',
	    },
	],
