...
countries = {
    ...
    ('at', 'de'): {  # Monuments in Austria in German
        ...
        'missingCommonscatPage': u'User:ErfgoedBot/Denkmal Österreich missing commons category links',
    ...
    ('ch', 'de'): {  # Monuments in Switzerland in German, lists with template 'Denkmalliste Schweiz Tabellenzeile'
        ...
        'rowTemplate': u'Denkmalliste Schweiz Tabellenzeile',
        'commonsTemplate': u'Cultural property of national significance in Switzerland',
        'commonsTrackerCategory': u'Cultural properties of national significance in Switzerland with known IDs',
        'commonsCategoryBase': u'Cultural properties of national significance in Switzerland',
    ...
    ('ch3', 'de'): {  # Monuments in Switzerland in German, lists with template 'Denkmalliste2 Schweiz-ZH Tabellenzeile'
        ...
        'rowTemplate': u'Denkmalliste2 Schweiz-ZH Tabellenzeile',
        'commonsTemplate': u'Cultural property of national significance in Switzerland',
        'commonsTrackerCategory': u'Cultural properties of national significance in Switzerland with known IDs',
        'commonsCategoryBase': u'Cultural properties of national significance in Switzerland',
        'unusedImagesPage': u'User:Multichill/Unused Schweizerisches Inventar der Kulturgüter von nationaler und regionaler Bedeutung images',  # FIXME: Better name
    ...
    ('cm', 'fr'): {  # Monuments in Cameroun in French
        ...
        'commonsTemplate': u'Cultural Heritage Cameroon',
        'commonsTrackerCategory': u'Cultural heritage monuments in Cameroon with known IDs',
        'commonsCategoryBase': u'Cultural heritage monuments in Cameroon',
        'unusedImagesPage': u'',
        # 'imagesWithoutIdPage': u'',
        'namespaces': [0],
    ...
    ('cz', 'cs'): {  # Monuments in Czech Republic in Czech language
        ...
        'autoGeocode': False,
        'missingCommonscatPage': u'Wikipedie:WikiProjekt Wiki Loves Monuments/Missing commons category links',
    ...
    ('fr', 'ca'): {  # Monuments in France in Catalan table
        ...
        'unusedImagesPage': u'Viquiprojecte:Monuments/Imatges per utilitzar de França',
    ...
    ('hk-hb', 'en'): {  # Historic Buildings (Grade I-III) in Hong Kong in English
        ...
        'commonsTemplate': u'Historic buildings Hong Kong',
        'unusedImagesPage': u'',
        'commonsTrackerCategory': u'Historic buildings of Hong Kong with known IDs‎',
        'commonsCategoryBase': u'Historic buildings of Hong Kong',
        'namespaces': [0],
    ...
    ('it', 'it'): {  # Monuments in Italy in Italian
        'project': u'wikipedia',
        'lang': u'it',
        'headerTemplate': u'WLM2015-intestazione-tabella',
        'rowTemplate': u'WLM2015-riga',
        ...
        'unusedImagesPage': u'Progetto:Wiki Loves Monuments 2015/immagini inutilizzate',
    ...
    ('nl-aw', 'nl'): {  # Monuments in Aruba in Dutch
        'project': u'wikipedia',
        'lang': u'nl',
        'headerTemplate': u'Tabelkop monumenten Aruba',
        'rowTemplate': u'Tabelrij monument Aruba',
        'commonsTemplate': u'Cultural Heritage Aruba',
        'commonsTrackerCategory': u'Cultural heritage monuments in Aruba with known IDs',
        'commonsCategoryBase': u'Cultural heritage monuments in Aruba',
        # 'autoGeocode': False,
        'unusedImagesPage': u'Wikipedia:Wikiproject/Erfgoed/Nederlandse Erfgoed Inventarisatie/Ongebruikte foto\'s van monumenten op Aruba',
        'imagesWithoutIdPage': u'Wikipedia:Wikiproject/Erfgoed/Nederlandse Erfgoed Inventarisatie/Foto\'s van monumenten op Aruba zonder id',
        'registrantUrlBase': u'',
        'namespaces': [0],
    ...
    ('nl-prov', 'nl'): {  # Provinciale monumenten in the Netherlands in Dutch
        'project': u'wikipedia',
        'lang': u'nl',
        'headerTemplate': u'Tabelkop provinciale monumenten',
        'rowTemplate': u'Tabelrij provinciaal monument',
        'commonsTemplate': u'Provinciaal monument',
        'commonsTrackerCategory': u'Provinciale monumenten with known IDs',
        'commonsCategoryBase': u'Provinciale monumenten',
        # 'autoGeocode': False,
        'unusedImagesPage': u'Wikipedia:Wikiproject/Erfgoed/Nederlandse Erfgoed Inventarisatie/Ongebruikte foto\'s van provinciale monumenten',
        ...
        'fields': [
            ...
            {
                'source': u'rijksmonument',
                'dest': u'rijksmonument',
            },
            {
                'source': u'aangewezen',
                'dest': u'aangewezen',
    ...
    ('pl-old', 'pl'): {  # Monuments in Poland in Polish (old system)
        'project': u'wikipedia',
        'lang': u'pl',
    ...
    ('se-bbr', 'sv'): {  # BBR Monuments in Sweden in Swedish
        ...
        'commonsTrackerCategory': u'Listed buildings in Sweden with known IDs',
        'commonsCategoryBase': u'Listed buildings in Sweden',
        'unusedImagesPage': u'Wikipedia:Projekt kulturarv/Oanvända bilder av byggnadsminnen i Sverige',
        'imagesWithoutIdPage': u'Wikipedia:Projekt kulturarv/Bilder av byggnadsminnen i Sverige utan ID',
    ...
    ('se-fornmin', 'sv'): {  # Fornminne Monuments in Sweden in Swedish
        ...
        'unusedImagesPage': u'Wikipedia:Projekt kulturarv/Oanvända bilder av fornlämningar i Sverige',
        'imagesWithoutIdPage': u'Wikipedia:Projekt kulturarv/Bilder av fornlämningar i Sverige utan ID',
    ...
    ('se-ship', 'sv'): {  # Listed historical ships in Sweden in Swedish
        ...
        'unusedImagesPage': u'Wikipedia:Projekt kulturarv/Oanvända bilder av kulturmärkta fartyg i Sverige',
        'imagesWithoutIdPage': u'Wikipedia:Projekt kulturarv/Bilder av kulturmärkta fartyg i Sverige utan ID',
    ...
    ('se-arbetsl', 'sv'): {  # Working Life Museums in Sweden in Swedish
        ...
        'unusedImagesPage': u'Wikipedia:Projekt kulturarv/Oanvända bilder av arbetslivsmuseum i Sverige',
        'imagesWithoutIdPage': u'Wikipedia:Projekt kulturarv/Bilder av arbetslivsmuseum i Sverige utan ID',
