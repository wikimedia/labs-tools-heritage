...
function handleBlackBerryLocation()
{
        ...
        if (bb_successCallback && bb_errorCallback)
        {
                if(blackberry.location.latitude==0 && blackberry.location.longitude==0)
                {
                        ...
                        alert("Sorry your position is unavailable.  This location browser requires you to set the option Browser->General->Javascript Location Support to 'enabled' on your Blackberry so that it can search from your location.  Only Blackberries with GPS are known to be supported.");		                        
        ...
        {		
                ...
                try
                {
                        ...
                        else if(typeof(window.blackberry)!="undefined" && blackberry.location.GPSSupported)
                        {
                        	...
                        	//alert('GPS Supported');	//Testing in
